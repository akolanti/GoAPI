...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/mcp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Question and optional request ID",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_akolanti_GoAPI_internal_api.MCPRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Job created - poll /mcp/status/{id}",
                        "schema": {
                            "$ref": "#/definitions/github_com_akolanti_GoAPI_internal_api.InitJobResponse"
                        }
                    },
        ...
        "/mcp/status/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Job ID from the /mcp response",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "github_com_akolanti_GoAPI_internal_api.MCPRequest": {
            "type": "object",
            "required": [
                "message"
            ],
        ...
        "github_com_akolanti_GoAPI_internal_api.Response": {
            "type": "object",
            "properties": {
                "answer": {
                    "type": "string"
        ...
        "github_com_akolanti_GoAPI_internal_api.Result": {
            ...
            "properties": {
                "response": {
                    "$ref": "#/definitions/github_com_akolanti_GoAPI_internal_api.Response"
                },
                "status": {
                    "type": "string"
                }
